...
const items = [
    ...
    {id: 2, link: "./courses/contract_system.html", img: 'intro_5.png', title: "Контрактная система в сфере закупок<br> для руководителей (44-ФЗ)", diplom: false, description: "Повышение квалификации<br>40 академических часа", price: "5 700"},
