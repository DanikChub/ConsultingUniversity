...
const ProgramHeader = ({ programTitle, setProgramTitle, programShortTitle, setProgramShortTitle, programPrice, setProgramPrice, programImg, handleImg }) => {
            ...
            <div className='MakeProgramInputs_group'>
                ...
                {preview || programImg ? (
                    <div className='relative h-[200px] w-[max-content]'>
                        <button className='MakeProgramInputs_group_preview_delete' onClick={() => setPreview(null)}>x</button>
                        <img k
