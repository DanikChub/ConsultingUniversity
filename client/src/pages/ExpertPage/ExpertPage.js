        ...
        <div className='no_head_footer'>
            ...
            <div className="intro bg-2">
                <div className="big_intro_container">
                    ...
                    <div className='intro_title'>ЭКСПЕРТ В СФЕРЕ ЗАКУПОК <br/> (44-ФЗ, 223-ФЗ)</div>
                    <div className='intro_subtitle'>для заказчиков</div>
            ...
            <div className="training_programs">
                <div className="big_container">
                    ...
                    <div className="training_programs_title">“Эксперт в сфере закупок (44-ФЗ, 223-ФЗ) для заказчиков” </div>
                    <div className="kit_buttons">
                        <div className="kit_button active">12 700 рублей</div>
