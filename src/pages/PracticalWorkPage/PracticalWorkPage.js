...
const PracticalWorkPage = () => {
    ...
    const handleFinishButton = () => {
        ...
        formData.append("task", "Подготовить сравнительный анализ положений Федеральных законов № 44-ФЗ и № 223-ФЗ.")
    ...
    return (
        ...
        <div className="container">
            ...
            <div className="finish_text" style={{marginTop: '25px'}}>Отчет о стажировке: Подготовить сравнительный анализ положений Федеральных законов № 44-ФЗ и № 223-ФЗ.</div>
